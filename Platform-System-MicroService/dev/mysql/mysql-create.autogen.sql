...
/* Database: XWAY                                               */
/*==============================================================*/
CREATE DATABASE XWAY;

ALTER DATABASE XWAY DEFAULT CHARACTER SET UTF8;


GRANT SELECT,INSERT,UPDATE,DELETE ON XWAY.* TO XWAY@LOCALHOST IDENTIFIED BY 'root';
DROP USER XWAY@LOCALHOST;

CREATE USER XWAY@LOCALHOST IDENTIFIED BY 'root';

GRANT SELECT,INSERT,UPDATE,DELETE,CREATE,DROP,ALTER,INDEX ON XWAY.* TO XWAY@LOCALHOST;
...
/*==============================================================*/
/* Table: XT_PROCESSDEFINITION                                  */
/*==============================================================*/
CREATE TABLE XT_PROCESSDEFINITION
(
   PROCESSDEFINITIONID  INT NOT NULL AUTO_INCREMENT,
   KEY                  VARCHAR(32) NOT NULL,
   NAME                 VARCHAR(32) NOT NULL,
   VERSION              INT NOT NULL DEFAULT 0,
   DESCRIPTION          VARCHAR(64),
   STATUS               VARCHAR(6) NOT NULL COMMENT 'Draft
            Deploy',
...
/*==============================================================*/
/* Table: XT_PROCESSDEFINITIONFLOW                              */
/*==============================================================*/
CREATE TABLE XT_PROCESSDEFINITIONFLOW
(
   PROCESSDEFINITIONFLOWID INT NOT NULL AUTO_INCREMENT,
   ...
   DESCRIPTION          VARCHAR(64),
   PRIMARY KEY (PROCESSDEFINITIONFLOWID)
)
ENGINE = INNODB;

/*==============================================================*/
/* Table: XT_PROCESSDEFINITIONNODE                              */
/*==============================================================*/
CREATE TABLE XT_PROCESSDEFINITIONNODE
(
   PROCESSDEFINITIONNODEID INT NOT NULL AUTO_INCREMENT,
   PROCESSDEFINITIONID  INT,
   TYPE                 VARCHAR(16) NOT NULL,
   KEY                  VARCHAR(32) NOT NULL,
   NAME                 VARCHAR(32) NOT NULL,
   ...
   COORDINATEX          INT,
   COORDINATEY          INT,
   PRIMARY KEY (PROCESSDEFINITIONNODEID)
)
ENGINE = INNODB;

/*==============================================================*/
/* Table: XT_PROCESSDEFINITIONNODEPROPERTIES                    */
/*==============================================================*/
CREATE TABLE XT_PROCESSDEFINITIONNODEPROPERTIES
(
   PROCESSDEFINITIONNODEPROPERTIESID INT NOT NULL AUTO_INCREMENT,
   PROCESSDEFINITIONNODEID INT,
   KEY                  VARCHAR(16) NOT NULL,
   VALUE                VARCHAR(64),
   PRIMARY KEY (PROCESSDEFINITIONNODEPROPERTIESID)
)
ENGINE = INNODB;

/*==============================================================*/
/* Table: XT_PROCESSINSTANCE                                    */
/*==============================================================*/
CREATE TABLE XT_PROCESSINSTANCE
(
   PROCESSINSTANCEID    INT NOT NULL AUTO_INCREMENT,
   PROCESSDEFINITIONID  INT,
...
ALTER TABLE XT_PROCESSDEFINITIONFLOW ADD CONSTRAINT FK_PROCESSDEFINITIONFLOW_PROCESSDEFINITION FOREIGN KEY (PROCESSDEFINITIONID)
      REFERENCES XT_PROCESSDEFINITION (PROCESSDEFINITIONID) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE XT_PROCESSDEFINITIONFLOW ADD CONSTRAINT FK_PROCESSDEFINITIONFLOW_PROCESSDEFINITIONNODE FOREIGN KEY (TARGETID)
      REFERENCES XT_PROCESSDEFINITIONNODE (PROCESSDEFINITIONNODEID) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE XT_PROCESSDEFINITIONFLOW ADD CONSTRAINT FK_PROCESSDEFINITIONFLOW_PROCESSDEFINITIONNODE2 FOREIGN KEY (SOURCEID)
      REFERENCES XT_PROCESSDEFINITIONNODE (PROCESSDEFINITIONNODEID) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE XT_PROCESSDEFINITIONNODE ADD CONSTRAINT FK_PROCESSDEFINITIONNODE_PROCESSDEFINITION FOREIGN KEY (PROCESSDEFINITIONID)
      REFERENCES XT_PROCESSDEFINITION (PROCESSDEFINITIONID) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE XT_PROCESSDEFINITIONNODEPROPERTIES ADD CONSTRAINT FK_PROCESSDEFINITIONNODEPROPERTIES_PROCESSDEFINITIONNODE FOREIGN KEY (PROCESSDEFINITIONNODEID)
      REFERENCES XT_PROCESSDEFINITIONNODE (PROCESSDEFINITIONNODEID) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE XT_PROCESSINSTANCE ADD CONSTRAINT FK_PROCESSINSTANCE_PROCESSDEFINITION FOREIGN KEY (PROCESSDEFINITIONID)
      REFERENCES XT_PROCESSDEFINITION (PROCESSDEFINITIONID) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE XT_TASK ADD CONSTRAINT FK_TASK_PROCESSINSTANCE FOREIGN KEY (PROCESSINSTANCEID)
      REFERENCES XT_PROCESSINSTANCE (PROCESSINSTANCEID) ON DELETE CASCADE ON UPDATE RESTRICT;
